...
export const metadata: Metadata = {
  title: "Gift Registry | Tim & Iyla's Wedding",
  description:
    "Gift registry information for Tim & Iyla's wedding celebration.",
  openGraph: {
    title: "Gift Registry | Tim & Iyla's Wedding",
    description:
      "Gift registry information for Tim & Iyla's wedding celebration.",
          ...
          <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="border p-6 rounded-lg text-center">
                ...
                <p className="mb-4">
                  Find our registry with items we&apos;ve selected for our new
                  home.
                </p>
                <a
                  href="#"
              ...
              <div className="border p-6 rounded-lg text-center">
                ...
                <p className="mb-4">
                  Browse our wishlist for our future together.
                </p>
                <a
                  href="#"
                  className="inline-block px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800 transition-colors"
            ...
            <div className="text-center border-t pt-6">
              ...
              <p className="mb-4">
                If you prefer, you can contribute to our honeymoon fund to help
                us create lasting memories on our first adventure as a married
                couple.
              </p>
              <a
                href="#"
